...
def main():
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            # Delete the generated speech file after playing it to avoid cluttering the filesystem.
            os.remove(tts_file)

            # Delete the captured image file after processing to avoid cluttering the filesystem.
            os.remove(image_filename)

            # Return the extracted text for further processing or use in the main script.
            return text_to_read
        except KeyError:
