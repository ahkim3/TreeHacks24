...
# image: ImageResponse, bounding_box_center: Tuple[int, int]
def walk_to_object(config, image, bounding_box_center):
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        # export picture taking logic outside of this function
        ...
        # the previous code segment was used to get the pixel to walk to, we need to replace this with
        # our yolo model

        robot.logger.info('Walking to object at image location (%s, %s)', bounding_box_center[0],
                          bounding_box_center[1])

        walk_vec = geometry_pb2.Vec2(x=bounding_box_center[0], y=bounding_box_center[1])
        ...
        # do not want to power off the robot when done
